...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".cta-form", rules1, checks, afterForm);
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".modal-form", rules2, checks2, afterForm);
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.works__slider', {
  slidesPerView: 1,
  spaceBetween: 20,
  speed: 500,
  pagination: {
...
const validateForms = function (selector, rules) {
  ...
  let checkSelector = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "";
  ...
  if (checkSelector) {
    validation.addRequiredGroup(checkSelector);
  }
